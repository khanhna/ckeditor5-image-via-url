/**
 * @module image-url-embed/ui/imageurlformview
 */
...
import '../../theme/imageviaurlform.css';

/**
 * The image-url form view controller class.
 *
 * @extends module:ui/view~View
 */
export default class ImageViaUrlFormView extends View {
	/**
	...
	constructor( validators, locale ) {
		 ...
		 */
		this.saveButtonView = this._createButton( t( 'Save' ), checkIcon, 'ck-button-save ck-button-margin' );
		 ...
		 * @member {module:ui/button/buttonview~ButtonView}
		 */
		this.cancelButtonView = this._createButton( t( 'Cancel' ), cancelIcon, 'ck-button-cancel ck-button-margin', 'cancel' );
	...
	_createUrlInput() {
		...
		inputView.placeholder = 'https://example.com/image';
